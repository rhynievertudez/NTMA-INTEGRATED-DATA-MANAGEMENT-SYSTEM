...
$sql_total_records = "SELECT COUNT(*) as total FROM `students_files`";
...
// Search Filter
if (!empty($searchTerm)) {
    $sql2 = "SELECT * FROM `students_files` WHERE `id` LIKE '%$searchTerm%' LIMIT $offset, $records_per_page";
} else {
    $sql2 = "SELECT * FROM `students_files` LIMIT $offset, $records_per_page";
}
...
$query_docs = "SELECT SUM(LENGTH(profile_file_data) - LENGTH(REPLACE(profile_file_data, ',', '')) + 1) AS total_docs FROM students_files WHERE profile_file_data IS NOT NULL";
...
$query_students = "SELECT COUNT(*) AS num_students FROM students_files WHERE status = 'Active'";
...
$query_alumni = "SELECT COUNT(*) AS num_alumni FROM students_files WHERE status = 'Alumni'";
$result_alumni = mysqli_query($conn, $query_alumni);
$row_alumni = mysqli_fetch_assoc($result_alumni);
$num_alumni = $row_alumni['num_alumni'];
?>
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-sm-6" id="small-content-docu">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6" id="small-content-stud">
                        <div class="icon-card mb-30">
                    ...
                    <!-- End Col -->
                    <div class="col-xl-3 col-lg-4 col-sm-6" id="small-content-alum">
                        <div class="icon-card mb-30">
                            <div class="icon success">
                                <i class="fa fa-graduation-cap"></i>
                            </div>
                            <div class="content">
                                <h6 class="mb-10">Alumni</h6>
                                <h3 class="text-bold mb-10">
                                    <?php echo $num_alumni; ?>
                                </h3>
                                <p class="text-sm text-success">
                ...
                <div class="tables-wrapper">
                    <div class="row">
                        <?php 
                include "dbcon.php";
                $query = "select * from students_files";
            ...
            if (!empty($searchKeyword)) {
                ...
                $sql = "SELECT * FROM students_files";
            }
            ...
            if ($result->num_rows > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                            ...
                            <a href='#' class='view' data-id='$id' title='View' data-toggle='tooltip'><i class='fa fa-eye' aria-hidden='true'></i></a>
                            <a href='#' class='edit' data-id='$id' title='Edit' data-toggle='tooltip'><i class='fa fa-edit' aria-hidden='true'></i></a>
                            <a href='#' class='delete' data-id='$id' title='Delete' data-toggle='tooltip'><i class='fa fa-trash' aria-hidden='true'></i></a>
                          </td>";
                    echo "</tr>";
                }
            } else {
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                $('.edit').click(function () {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (response) {
                                                            ...
                                                            $('#page').hide();
                                                            $('#title').hide();
                                                            $('#small-content-stud').hide();
                                                            $('#small-content-alum').hide();
                                                            $('#small-content-docu').hide();
                                                ...
                                                $('#details-section').on('click', '.back-button', function () {
                                                    ...
                                                    $('.back-button').hide();
                                                    $('#title').show();
                                                    $('#small-content-stud').show();
                                                    $('#small-content-alum').show();
                                                    $('#small-content-docu').show();
